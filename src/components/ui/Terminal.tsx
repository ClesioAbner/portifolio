...
const skillsList = ['Java', 'JavaScript', 'HTML', 'CSS', 'React', 'TypeScript', 'SQL', 'PostgreSQL'];
...
export const Terminal: React.FC<TerminalProps> = ({ isExpanded, onToggle }) => {
    ...
    const commands = React.useMemo<{ [key: string]: () => React.ReactNode }>(() => ({
        help: () => `Comandos disponíveis:\n- sobre: Mostra uma breve descrição.\n- skills: Lista as habilidades técnicas.\n- educacao: Mostra a formação académica.\n- contacto: Mostra os contactos.\n- clear: Limpa o terminal.\n- exit: Fecha o terminal.`,
        sobre: () => 'Estudante finalista de Engenharia Informática no ISCTEM, com experiência em desenvolvimento web e programação em Java. Apaixonado por criar soluções práticas e aprender novas tecnologias.',
        skills: () => 'Habilidades: ' + skillsList.join(', '),
        educacao: () => 'Licenciatura em Engenharia Informática – ISCTEM (4.º ano)\nCisco Networking Academy – Ethical Hacker & JavaScript Essentials 1\nIFBM – Formação Bancária',
        contacto: () => 'Email: eclesioabner@gmail.com\nLinkedIn: linkedin.com/in/eclésio-abner-pembelane\nGitHub: github.com/ClesioAbner',
        clear: () => {
            setHistory([]);
                ...
                {!isExpanded ? (
                    ...
                    >
                        <header className="bg-gray-200/50 dark:bg-gray-800/50 p-3 flex items-center justify-between rounded-t-lg select-none flex-shrink-0">
                            ...
                            <span className="text-blue-600 dark:text-green-400 text-sm truncate mx-2">eclesio@portfolio: ~</span>
                            ...
                            {history.map((entry, index) => (
                                <div key={index}>
                                    <div className="flex items-center">
                                        <span className="text-blue-600 dark:text-green-400">eclesio@portfolio:~$</span>
