...
const socialLinks = [
    { icon: FaLinkedin, href: 'https://www.linkedin.com/in/ecl%C3%A9sio-abner-pembelane' },
    { icon: FaGithub, href: 'https://github.com/ClesioAbner' },
    { icon: FaEnvelope, href: 'mailto:eclesioabner@gmail.com' },
];
                        ...
                        {socialLinks.map((link, index) => {
                            ...
                            return (
                                <motion.a
                                    ...
                                    whileHover={{ scale: [1, 1.15, 1], transition: { duration: 1, repeat: Infinity, ease: 'easeInOut' } }}
                                >
                                    <Icon size={32} />
                                </motion.a>
                            );
                    ...
                    <div className="h-6 mt-1 text-center">
                        <AnimatePresence mode="wait">
                            {submitStatus === 'success' && (
                                <motion.p key="success" variants={notificationVariants} initial="hidden" animate="visible" exit="exit" className="font-semibold text-green-500">
                                    Mensagem enviada com sucesso!
                                </motion.p>
                            )}
                            {submitStatus === 'error' && (
                                <motion.p key="error" variants={notificationVariants} initial="hidden" animate="visible" exit="exit" className="font-semibold text-red-500">
