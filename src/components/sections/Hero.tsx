...
export const Hero: React.FC = () => {
    ...
    const imageUrl = import.meta.env.BASE_URL + '/images/1997.jpeg';
    const cvUrl = import.meta.env.BASE_URL + '/pdf/Eclesio.pdf';
    ...
    const handleDownloadCV = async () => {
        ...
        a.href = url;
        a.download = 'Eclesio_Abner_curriculo.pdf';
    ...
    return (
        <section id="hero" className="min-h-screen flex flex-col items-center justify-center text-center relative overflow-hidden">
            <motion.div style={{ y }} className="w-full flex flex-col items-center justify-center">
                ...
                >
                    Desenvolvedor | Java, React, JavaScript & SQL
                </motion.p>
                <motion.div
